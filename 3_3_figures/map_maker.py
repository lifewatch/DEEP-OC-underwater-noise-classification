...
# # Read the background
# shipping_path = '//fs/shared/onderzoek/6. Marine Observation Center/Projects/PhD_Clea/Data/bpns_env_data/' \
#                 'maps/EMODnet_HA_Vessel_Density_all_2017-2021Avg/2021_st_All_avg.tif'

# borders_EEZ = "//fs/shared/datac/Geo/Layers/Belgium/administrativeunits/maritime_boundaries/MarineRegions/" \
#               "eez_boundaries_v10_BE_epsg4326.shp"
...
# output_folder = pathlib.Path('//fs/shared/onderzoek/6. Marine Observation Center/Projects/Lifewatch\broadband_acoustic_network\stations_and_planning' \
#                              'Broadband acoustic network/')
                             
# locations_path = output_folder.joinpath('Locations_ETN2.csv')

# df = pd.read_csv(locations_path)
# df = df.loc[~f.stationName.isin(['GardenCity', 'Grafton'])]
...
# # Read the station coordinates
# output_folder = pathlib.Path('C:/Users/cleap/Desktop/forum_acusticum/img')
...
#                            maxx, maxy).plot(ax=ax, add_colorbar=True, cbar_kwargs={'label': r'Vessel density [$h/km^2/month$]'},
#                                             cmap='YlOrRd', zorder=0,
#                                             norm=colors.SymLogNorm(linthresh=0.03, linscale=0.03,
#                                               vmin=1, vmax=100, base=10), shading='auto', alpha=0.7)
...
# plt.title(None)
# plt.savefig(output_folder.joinpath('shipping_map.png'), dpi=350, bbox_inches="tight")
# plt.show()
...
borders_EEZ = r"\\fs\SHARED\datac\Geo\Layers\Belgium\administrativeunits\maritime_boundaries\MarineRegions\eez_boundaries_v10_BE_epsg4326.shp" 
...
# Read the station coordinates
output_folder = pathlib.Path(r'\\fs\SHARED\onderzoek\6. Marine Observation Center\Projects\Lifewatch\broadband_acoustic_network\stations_and_planning')
locations_path = output_folder.joinpath('Locations_ETN2.csv')
...
save_path = r'C:\Users\wout.decrop\OneDrive - VLIZ\Documents\Papers\Vessel_detection\Figures\data_collection\shipping_map.png'
